...
static void toJsonStringBase(const Artifact& artifact, const std::string& contentType, JsonDoc& doc)
{
    ...
    doc.addMember(kStrBegin,       toIsoTimeString(artifact.begin));
    doc.addMember(kStrEnd,         toIsoTimeString(artifact.end));
...
std::string toJsonString(const Track& track, const std::string& contentType)
{
    ...
    doc.addMember(kStrObjectId, track.objectId);
    doc.addMember(kStrFrameWidth, track.frameWidth);
    doc.addMember(kStrFrameHeight, track.frameHeight);
